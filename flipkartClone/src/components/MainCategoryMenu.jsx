...
const MainCategoryMenu = () => {
  return ( 
    ...
    <div id='griddata'>
        ...
        <div><img src="https://encrypted-tbn3.gstatic.com/images?q=tbn:ANd9GcSkHK0LgWLD8IpFKXnQue41l5q_NiOFDnMUfMSMoEU0kgh7-AvK" alt="" /><p className="category">Fashion</p></div>
